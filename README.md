...
[![codecov](https://codecov.io/gh/ypankaj007/go-openai/branch/master/graph/badge.svg?token=bCbIfHLIsW)](https://codecov.io/gh/ypankaj007/go-openai)
...
Installation:
```
go get github.com/ypankaj007/go-openai
```
...
import (
	"context"
	"fmt"
	openai "github.com/ypankaj007/go-openai"
)
...
See also: https://pkg.go.dev/github.com/ypankaj007/go-openai#ClientConfig
</details>
...
import (
	...
	"github.com/ypankaj007/go-openai"
)
